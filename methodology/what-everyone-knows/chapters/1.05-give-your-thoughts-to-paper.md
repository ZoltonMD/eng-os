## 1.05 Offloading the Cache: The Power of Paper.
...
The first problem people usually encounter when using paper notes is its *searchability*. Indeed, you can add an index page into your notebook; you even can create a page to indicate which page each tag is on. However, you will never get the same *searchability* as in a digital notebook, where you can instantly find every page containing the a specific keyword or phrase.
