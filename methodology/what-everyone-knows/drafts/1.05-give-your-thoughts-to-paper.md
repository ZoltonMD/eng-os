...
The digital environment prevents you from fully concentrating. Even if you avoid the distractions, another form of friction appears: "Where do I put this? What tag do I use? Why does the spellchecker underline this word?". All of this creates **Input Latency**, which can sometimes be longer than the thinking process itself.
